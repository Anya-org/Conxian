...
(define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
  (begin (asserts! (is-eq tx-sender sender) (err u1000)) (ft-transfer? mock-token amount sender recipient))
)
...
(define-public (mint (amount uint) (recipient principal)) (ft-mint? mock-token amount recipient))
