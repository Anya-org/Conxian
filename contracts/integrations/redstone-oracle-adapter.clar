...
(define-public (verify-data-package
  ...
  (begin
    ...
    (print {
      event: "redstone-data-verified", timestamp: timestamp, tenure-id: (/ stacks-block-height u10)
    })
    (ok true)
  )
)
