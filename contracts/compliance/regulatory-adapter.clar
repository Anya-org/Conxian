...
;; Clarity 4 Standard: Using burn-block-height and to-ascii? for human-readable audit trails.
...
(define-public (add-to-blacklist (user principal))
  (begin
    ...
    ;; Use burn-block-height for second-precision audit logs (Clarity 4)
