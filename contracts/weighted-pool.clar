;; Conxian Weighted Pool Implementation - PRODUCTION READY
...
(define-data-var pool-token-x principal .CXG-token)
(define-data-var pool-token-y principal .CXLP-token)
