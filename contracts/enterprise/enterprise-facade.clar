...
(define-public (register-institution
  ...
  (begin
    ...
    (contract-call? .institutional-account-manager register-institution
      institution tier limit
    )
  )
)

(define-public (set-account-limit
    (institution principal)
    (new-limit uint)
  )
  (begin
    ...
    (contract-call? .institutional-account-manager set-limit institution
      new-limit
    )
  )
)
