...
(define-constant ERR_CONTRACT_DEPRECATED u9005)
...
(define-public (set-active-version 
  ...
  (begin
    ...
    (let ((contract-info (unwrap! (map-get? contract-registry {contract-type: contract-type, version: version})
      ...
      ;; Ensure contract version is not deprecated
      (asserts! (not (get deprecated contract-info)) (err ERR_CONTRACT_DEPRECATED))
...
(define-public (deprecate-version 
  ...
  (begin
    ...
    (let ((contract-info (unwrap! (map-get? contract-registry {contract-type: contract-type, version: version})
      ...
      (map-set contract-registry
        {contract-type: contract-type, version: version}
        (merge contract-info {deprecated: true, last-updated: block-height}))
      (print {
        event: "version-deprecated",
        contract-type: contract-type,
        version: version
      })
      (ok true)))
