...
- **Enhancement**: Native discovery of sBTC and USDCx balances with real-time Pyth-verified pricing.
...
- **Enhancement**: Emily API client integration; standardized Wormhole VAA handlers.
...
- **Enhancement**: Extended state to include Merkle-proven sBTC and USDCx ledger entries.
