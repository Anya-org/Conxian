...
No errors detected. All contracts pass validation.
...
A new deployment plan was computed and differs from the default deployment plan currently saved on disk:
  ...
  genesis:
    wallets:
      - name: deployer
-       address: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+       address: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
        balance: "0"
        sbtc-balance: "1000000000"
      - name: wallet_1
-       address: ST3GX1X5GPZHJM68GKWK653NXEJ90GFJR2GMZSC9Y
+       address: ST14EF40WNQTYBYHH7FG3NC9MNACE3D9YTV5YF63J
        balance: "0"
        sbtc-balance: "1000000000"
      - name: wallet_2
-       address: STMJQM9HC9DGS2YACC7PBSTPYP84CQEN6FHR5ZB9
+       address: ST3JKBYRWYTNNVQVP3B54TDKYZP8VV5MKS3DRKKN4
        balance: "0"
        sbtc-balance: "1000000000"
      - name: wallet_3
-       address: ST3G0C7YZXX2NJC4HG04C90V2HFTJ1HYE8T1JM9A9
+       address: STZG44QG555N1N4GFQ6CBKJXVMZ7AWSMSX4HTYZZ
        balance: "0"
        sbtc-balance: "1000000000"
    contracts:
      - genesis
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\automation-traits.clar"
              clarity-version: 1
          - emulated-contract-publish:
              contract-name: conxian-service-trait
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\conxian-service-trait.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\sip-standards.clar"
              clarity-version: 1
          - emulated-contract-publish:
              contract-name: core-traits
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\core-traits.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\defi-traits.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\security-monitoring.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\treasury\\cxd-treasury.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              ...
              clarity-version: 1
          - emulated-contract-publish:
              contract-name: concentrated-math
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\tokens\\cxd-token.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\governance-traits.clar"
              clarity-version: 1
          - emulated-contract-publish:
...
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\treasury\\revenue-distributor.clar"
              clarity-version: 1
          - emulated-contract-publish:
              contract-name: vault-traits
-             emulated-sender: ST1QJSFF6PBBQH422QVRHXMY643FB5HHJE8QHM3FP
+             emulated-sender: STC8M77PA8ANWE06BDCFWBWGSY3Z0E16ZRNVPDES
              path: "contracts\\traits\\vault-trait.clar"
              clarity-version: 1
        epoch: "2.05"
Overwrite? [Y/n]
note: using deployments/default.simnet-plan.yaml
 33 contracts checked
