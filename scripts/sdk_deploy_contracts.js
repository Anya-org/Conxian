...
const ORDER = [
  'sip-010-trait','strategy-trait','vault-admin-trait','vault-trait','mock-ft','gov-token','treasury','vault','timelock','dao','dao-governance','analytics','registry','bounty-system','creator-token','dao-automation','CXG-token','CVLP-token'
];
