...
- **Sovereignty-Adjusted Fee (SAF)**: 0.25% base fee on Multi-chain swaps, with up to 50% discount based on age/volume, and a 20% discount for TEE usage.
- **Revenue Distribution (CXIP-013)**: Fees above the Founder's Cut are distributed automatically: 15% LP, 45% Treasury, 30% Bounties, 5% Grants, 5% Buy-back.
