...
2.  **Non-Dilutive Capital**: Equity is legacy. All capital raising must utilize **Bitcoin DLC Bonds** or yield-bearing instruments. If debt is issued, it must be programmatically settled via `Fiscal-Vault-Oracle`.
...
*   **Sovereignty**: Global regulatory compliance and jurisdictional sharding (SARB/SARS/BIS).
    *   *Lead Component*: `Sovereign-Strategy-Nexus/docs/SARB_MARCH_2026_MANDATE.md`.
...
*   **Alliances**: Institutional BD and real-time M&A velocity.
    *   *Lead Component*: `Sovereign-Strategy-Nexus/REALTIME_M&A_VELOCITY.md`.
...
*   **Integrations**: DePIN and protocol partnerships (Akash/Bittensor).
    *   *Lead Component*: `Fiscal-Vault-Oracle/BOS_INTEGRATION_MAP.md`.
...
*   **Compute Forge**: DePIN arbitrage and sovereign node procurement.
    *   *Lead Component*: `Sovereign-Ops-Orchestrator/DEPLOYMENT_EFFICIENCY.md`.
...
*   **Capital Forge**: Bitcoin DLC Bonds and non-dilutive debt lifecycle.
    *   *Lead Component*: `Fiscal-Vault-Oracle/BITCOIN_BOND_DLC.json`.
...
*   **Synthesis**: Market intelligence and exit readiness (ZK-Data Room).
    *   *Lead Component*: `Sovereign-Strategy-Nexus/docs/ZK_DATA_ROOM_SCHEMA.md`.
*   **Horizon**: Macro liquidity cycles and sovereign runway.
    *   *Lead Component*: `Fiscal-Vault-Oracle/SOVEREIGN_RUNWAY.md`.
*   **Frontier**: Emerging tech research (ZKML, new TEE architectures).
    *   *Lead Component*: `Fiscal-Vault-Oracle/OPENCLAW_TEE_SPEC.md`.
...
*   **Identity**: Agent reputation, **LEI Verification**, and ERC-8004.
    *   *Lead Component*: `Fiscal-Vault-Oracle/WEB5_IDENTITY_AUDIT.md`.
...
*   **Strategos Warden**: Shadow dependency scanning and nomenclature enforcement.
    *   *Lead Component*: `Nakamoto-Guardian/ANTI_FRAGILITY_LOOP.md`.
